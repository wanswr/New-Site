      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
           <div className="mb-20 md:mb-32 text-center lg:text-left">
              ...
              <h2 ref={titleRef} className="text-4xl md:text-6xl font-serif text-luxury-text mb-8 leading-tight tracking-tighter w-full">
                Получите расчет <br />
                <span className="italic text-luxury-brass/80 font-normal">вашего проекта</span>
              </h2>
           </div>
           ...
           <div className="grid lg:grid-cols-2 gap-20 lg:gap-40 items-start">
             <form className="space-y-12 final-reveal" onSubmit={handleSubmit}>
               <div className="group relative">
                 ...
                 <input id="user-name" type="text" className="w-full bg-transparent border-b border-luxury-brass/20 py-4 text-lg md:text-xl font-serif text-luxury-text focus:border-luxury-brass outline-none transition-all placeholder:text-luxury-text/10 cursor-pointer" placeholder="Ваше имя" required />
               </div>
               <div className="group relative">
                 ...
                 <input id="user-phone" type="tel" className="w-full bg-transparent border-b border-luxury-brass/20 py-4 text-lg md:text-xl font-serif text-luxury-text focus:border-luxury-brass outline-none transition-all placeholder:text-luxury-text/10 cursor-pointer" placeholder="+7 (___) ___-__-__" required />
               </div>

               <button
                 type="submit"
                 disabled={formStatus !== "idle"}
                 className="group relative w-full h-16 bg-luxury-brass overflow-hidden transition-all duration-700 cursor-pointer disabled:opacity-50"
               >
                 <span className="relative z-10 text-[10px] uppercase tracking-[0.6em] text-black font-bold">
                   {formStatus === "idle" && "Получить расчет стоимости"}
             ...
             <div className="space-y-16 final-reveal">
                <div className="space-y-6">
                   <span className="text-luxury-brass text-[10px] uppercase tracking-[0.6em] block opacity-60 font-bold">Контакты</span>
                   <p className="text-lg md:text-xl font-serif text-luxury-text leading-relaxed">
                     Москва и Московская область <br />
                     <span className="text-[10px] uppercase tracking-[0.4em] text-luxury-text-muted font-sans font-bold block mt-4 italic">Ежедневно с 9:00 до 21:00</span>
                   </p>
                </div>

                <div className="space-y-6">
                   <span className="text-luxury-brass text-[10px] uppercase tracking-[0.6em] block opacity-60 font-bold">Связь</span>
                   <div className="flex flex-col gap-4 text-lg md:text-xl font-serif text-luxury-text">
                      <a href="tel:+79990000000" className="hover:text-luxury-brass transition-colors cursor-pointer">+7 (999) 000-00-00</a>
                      <a href="https://wa.me/placeholder" className="hover:text-luxury-brass transition-colors cursor-pointer">Написать в WhatsApp</a>
                   </div>
                </div>

                <div className="flex gap-8 pt-8 border-t border-luxury-brass/10">
                   <a href="#" className="text-[10px] uppercase tracking-[0.4em] text-luxury-text-muted hover:text-luxury-brass transition-colors cursor-pointer font-bold">Telegram</a>
                   <a href="#" className="text-[10px] uppercase tracking-[0.4em] text-luxury-text-muted hover:text-luxury-brass transition-colors cursor-pointer font-bold">WhatsApp</a>
                </div>
             </div>
           </div>

           <div className="mt-32 pt-16 border-t border-luxury-brass/5 text-center opacity-30">
              <span className="text-[8px] uppercase tracking-[1.5em] text-luxury-text font-bold">PotolokBel © 2024 • Премиальные натяжные потолки</span>
           </div>
      </div>
    </div>
  );
