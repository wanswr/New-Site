...
export default function FinalScene() {
  ...
  return (
    <div id="final-scene" ref={containerRef} className="relative w-full min-h-screen bg-[#0F0F0F] overflow-hidden py-16 md:py-24 flex flex-col justify-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
           <div className="mb-12 md:mb-20 text-center lg:text-left">
              <span className="final-reveal text-luxury-brass text-[9px] uppercase tracking-[0.8em] block font-bold mb-4 ">
                СПЕЦИАЛЬНОЕ ПРЕДЛОЖЕНИЕ
              </span>
              <h2 ref={titleRef} className="text-3xl md:text-6xl font-serif text-luxury-text mb-6 leading-tight tracking-tighter w-full ">
           ...
           <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start w-full">
             <form className="space-y-8 final-reveal w-full" onSubmit={handleSubmit}>
               <div className="group relative">
                 <label htmlFor="user-name" className="block text-[9px] uppercase tracking-[0.4em] text-luxury-brass mb-1 opacity-40 group-focus-within:opacity-100 transition-opacity font-bold ">Имя</label>
               ...
               <div className="group relative">
                 <label htmlFor="user-phone" className="block text-[9px] uppercase tracking-[0.4em] text-luxury-brass mb-1 opacity-40 group-focus-within:opacity-100 transition-opacity font-bold ">Телефон</label>
               ...
               >
                 <span className="relative z-10 text-[9px] uppercase tracking-[0.6em] text-black font-bold ">
             ...
             <div className="space-y-12 final-reveal w-full">
                <div className="space-y-4">
                   <span className="text-luxury-brass text-[9px] uppercase tracking-[0.6em] block opacity-60 font-bold ">Контакты</span>
                   <p className="text-base md:text-xl font-serif text-luxury-text leading-relaxed ">
                     Москва и Московская область <br />
                     <span className="text-[9px] uppercase tracking-[0.4em] text-luxury-text-muted font-sans font-bold block mt-2 italic ">Ежедневно с 9:00 до 21:00</span>
                   </p>
                </div>

                <div className="space-y-4">
                   <span className="text-luxury-brass text-[9px] uppercase tracking-[0.6em] block opacity-60 font-bold ">Связь</span>
           ...
           <div className="mt-16 pt-8 border-t border-white/5 text-center opacity-30">
              <span className="text-[7px] uppercase tracking-[1.5em] text-luxury-text font-bold ">PotolokBel © 2024 • Премиальные натяжные потолки</span>
           </div>
      </div>
    </div>
  );
