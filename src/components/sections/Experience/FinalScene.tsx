...
export default function FinalScene() {
  return (
    <div id="final-scene" className="absolute inset-0 w-full h-full pointer-events-auto overflow-hidden bg-premium-white">
      <div id="final-bg" className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-premium-white via-premium-white/80 to-transparent" />
      </div>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 md:p-12 overflow-y-auto py-20 scrollbar-hide">
        <div className="max-w-6xl w-full">
           <div className="mb-12 md:mb-24 text-center">
              ...
              <h2 className="text-[clamp(2.5rem,10vw,10rem)] font-serif text-premium-graphite mb-8 md:mb-12 leading-[0.8] tracking-tighter">
                Создадим <br />
           ...
           <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-start">
             <form className="space-y-12 md:space-y-16">
               <div className="group relative">
                 ...
                 <input type="text" className="w-full bg-transparent border-b border-premium-brass/20 py-2 md:py-4 text-lg md:text-2xl font-serif text-premium-graphite focus:border-premium-brass outline-none transition-all placeholder:text-premium-graphite/5" placeholder="Александр" />
               </div>
               <div className="group relative">
                 ...
                 <input type="tel" className="w-full bg-transparent border-b border-premium-brass/20 py-2 md:py-4 text-lg md:text-2xl font-serif text-premium-graphite focus:border-premium-brass outline-none transition-all placeholder:text-premium-graphite/5" placeholder="+7" />
               </div>
             ...
             <div className="space-y-12 md:space-y-16 pt-8 md:pt-0">
                <div className="space-y-4 md:space-y-8">
                   ...
                   <p className="text-lg md:text-2xl font-serif text-premium-graphite leading-relaxed">
                     Москва, Кутузовский проспект, 12 <br />
                     <span className="text-[10px] md:text-sm uppercase tracking-widest text-premium-graphite/40 font-sans font-bold">Boutique Showroom</span>
                   </p>
                </div>

                <div className="space-y-4 md:space-y-8">
                   <span className="text-premium-brass text-[8px] uppercase tracking-widest block opacity-40">Связь</span>
                   <div className="flex flex-col gap-2 md:gap-4 text-lg md:text-2xl font-serif text-premium-graphite">
                ...
                <div className="flex gap-8 md:gap-12 pt-4 md:pt-8">
                   <a href="#" className="text-[10px] uppercase tracking-[0.3em] text-premium-graphite/40 hover:text-premium-brass transition-colors">Telegram</a>
                   <a href="#" className="text-[10px] uppercase tracking-[0.3em] text-premium-graphite/40 hover:text-premium-brass transition-colors">WhatsApp</a>
                   <a href="#" className="text-[10px] uppercase tracking-[0.3em] text-premium-graphite/40 hover:text-premium-brass transition-colors">Pinterest</a>
                </div>
             </div>
           </div>
        </div>
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-20">
           <span className="text-[8px] uppercase tracking-[2em] whitespace-nowrap text-premium-graphite font-bold">PotolokBel Architectural Surfaces</span>
        </div>
      </div>
    </div>
  );
