      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
           ...
           <div className="grid lg:grid-cols-2 gap-20 lg:gap-40 items-start">
             <form className="space-y-12 final-reveal">
               ...
               <div className="group relative">
                 <label className="block text-[10px] uppercase tracking-[0.4em] text-luxury-brass mb-2 opacity-40 group-focus-within:opacity-100 transition-opacity font-bold">Телефон</label>
                 <input type="tel" className="w-full bg-transparent border-b border-luxury-brass/20 py-4 text-lg md:text-xl font-serif text-luxury-text focus:border-luxury-brass outline-none transition-all placeholder:text-luxury-text/10 cursor-none" placeholder="+7" />
               </div>

               <button className="group relative w-full h-16 bg-luxury-brass overflow-hidden transition-all duration-700 cursor-none">
                 <span className="relative z-10 text-[10px] uppercase tracking-[0.6em] text-black font-bold">Начать Проект</span>
